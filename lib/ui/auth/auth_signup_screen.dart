...
import 'package:photo_app/ui/auth/signup_with_email.dart';
                ...
                child: Column(
                  ...
                  children: [
                    buildCircularButton(
                      ...
                      Colors.blue,
                      () => push(context, SignUpWithEmail(), 'SignUpWithEmail', false),
                    ),
                    SizedBox(height: 10),
                    buildCircularButton(
                      'Google',
      ...
      child: Container(
        ...
        child: Stack(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[Text(title, style: TextStyle(fontSize: 16, color: Colors.black54))],
            ),
          ],
        ),
      ),
